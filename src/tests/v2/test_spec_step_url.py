...
class TestSpecStepUrl:
    def test_verify_1(self):
        ...
        with pytest.raises(requests.exceptions.SSLError):
            bdast.bdast_v2.process_step_url(
                action_state, {"url": "https://expired.badssl.com/", "method": "get"}
            )
    ...
    def test_verify_3(self):
        ...
        with pytest.raises(requests.exceptions.SSLError):
            bdast.bdast_v2.process_step_url(
                action_state,
                {"url": "https://expired.badssl.com/", "method": "get", "verify": True},
            )
    ...
    def test_verify_4(self):
        ...
        bdast.bdast_v2.process_step_url(
            action_state,
            {"url": "https://www.google.com/", "method": "get", "verify": True},
        )
    ...
    def test_verify_5(self):
        ...
        bdast.bdast_v2.process_step_url(
            action_state, {"url": "https://www.google.com/", "method": "get"}
        )
    ...
    def test_noverify_1(self):
        ...
        bdast.bdast_v2.process_step_url(
            action_state,
            {"url": "https://www.google.com/", "method": "get", "verify": False},
        )
    ...
    def test_noverify_2(self):
        ...
        bdast.bdast_v2.process_step_url(
            action_state,
            {"url": "https://expired.badssl.com/", "method": "get", "verify": False},
        )
    ...
    def test_check_1(self):
        ...
        bdast.bdast_v2.process_step_url(
            action_state, {"url": "https://www.google.com.au", "method": "get"}
        )
    ...
    def test_check_3(self):
        ...
        bdast.bdast_v2.process_step_url(
            action_state,
            {"url": "https://www.google.com.au", "method": "get", "status_check": 200},
        )
